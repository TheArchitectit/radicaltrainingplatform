...
/// <summary>
/// Keyword-based reference and KB link service.
/// Data sourced from official Nutanix documentation.
/// </summary>
public class HardcodedReferenceService : IReferenceService
{
    ...
    public string GetReferenceForQuestion(Question q)
    {
    ...
    public List<(string Title, string Url)> GetKBLinksForQuestion(Question q)
    {
    ...
    public List<(string Title, string Url)> GetGeneralResources() => _generalResources;
}
