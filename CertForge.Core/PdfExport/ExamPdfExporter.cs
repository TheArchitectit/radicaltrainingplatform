...
namespace CertForge.Core.PdfExport;
...
public static class ExamPdfExporter
{
    ...
    private static void ComposeFooter(IContainer container)
    {
        ...
        {
            row.RelativeItem().Text("CertForge - Nutanix Certification Practice")
                .FontSize(8)
                .FontColor(Color.FromHex(MutedColor));
        ...
        DateTime generatedAt)
    {
        ...
        {
            col.Item().PaddingTop(40).Text("CertForge")
                .FontSize(14).Bold()
            ...
            col.Item().PaddingTop(80).Text("- CertForge -")
                .FontSize(10)
                .FontColor(Color.FromHex(AccentMagenta))
                .AlignCenter();
        });
