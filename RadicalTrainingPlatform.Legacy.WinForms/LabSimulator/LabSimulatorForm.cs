...
namespace RadicalTrainingPlatform.LabSimulator;
...
sealed class LabSimulatorForm : Form
{
    ...
    {
        Text = "Nutanix Lab Simulator — RadicalTrainingPlatform";
    ...
    private async void InitWebView()
    {
        try
        {
            ...
            var userDataFolder = Path.Combine(
                ...
                "RadicalTrainingPlatform", "WebView2Data");
            ...
            _webView.CoreWebView2.SetVirtualHostNameToFolderMapping(
                "radicaltrainingplatform.local", webRoot,
            ...
            _webView.CoreWebView2.Navigate("https://radicaltrainingplatform.local/index.html");
